...
<p>
    ...
    testpage for Security Token Service. Any misuse will be prosecuted.<br>
    ...
    <div class="col-md-8">
        <FORM id="applicationlogonform" action="logon" method="post" role="form" class="form-horizontal">
            <div class="form-group">
                <label for="applicationcredential" class="col-md-2">Applicationcredential:</label>
                <div class="col-md-10">
                   <TEXTAREA id="applicationcredential" NAME="applicationcredential" COLS=80 ROWS=7>${applicationcredential?html}</TEXTAREA>
               </div>
            </div>
            <div class="form-group">
                <label for="applicationlogonformurl" class="col-md-2">Url:</label> 
                <div class="col-md-10">
...
<div class="row">
    <div class="col-md-8">
        <FORM id="getusertokenform" method="post" action="." role="form" class="form-horizontal">
            ...
            <div class="form-group">
                <label for="apptoken2"  class="col-md-2">Apptoken:</label>
                <div class="col-md-10">
                    <TEXTAREA id="apptoken2" NAME="apptoken" COLS=80 ROWS=11 placeholder="apptokenxml inn her"></TEXTAREA>
                </div>
            </div>
            <div class="form-group">
                <label for="usertokenidparam" class="col-md-2">Usertokenid:</label>
                <div class="col-md-10">
