...
public class AppExceptionCode {
	...
	public static AppException USER_LOGIN_PIN_FAILED_6004 = new AppException(Status.NOT_ACCEPTABLE, 6004, "Attempt to access with non acceptable username/phoneno", "Attempt to access with non acceptable username/phoneno", "");
	public static AppException USER_USER_EMAIL_NOTFOUND_6005 = new AppException(Status.NOT_ACCEPTABLE, 6005, "Attempt to access with non acceptable user's email", "Attempt to access with non acceptable user's email", "");
	public static AppException USER_INVALID_PINCODE_6006 = new AppException(Status.NOT_ACCEPTABLE, 6006, "Invalid pin code", "Invalid pin code", "");
